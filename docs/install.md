...
| `current_endpoint_key_id` | string | | The id for the current long-term node key pair |
| `current_endpoint_session_key_id` | string | | The id for the current, initial session key pair |
